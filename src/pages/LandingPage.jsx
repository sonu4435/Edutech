...
const LandingPage = () => {
    return (
        <div className='h-screen  w-full flex relative pt-16'>
            <div className="LeftSide w-1/2 flex h-full flex-col items-start mt-48 p-5">
                ...
                <div className="middleText w-full flex p-20 pt-5">
                    <h1 className='font-bold text-7xl leading-[5rem] tracking-wide font-dosis capitalize'>Empower Your Future Where Aspirations Meet Opportunities</h1>
                </div>
            ...
            <div className="RightSide w-1/2 h-full flex items-start mt-28 justify-center overflow-hidden rounded-2xl">
                <div className="image w-2/4 h-2/3">
                    <img draggable={false} className='h-full w-full select-none object-cover object-top' src={"https://i.pinimg.com/736x/49/38/fe/4938fe5c5cc4a7121208bbf3e9fc0534.jpg"} alt="." />
                </div>
            </div>
        </div>
    )
